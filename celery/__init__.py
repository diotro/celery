...
version_info_t = namedtuple(
    'version_info_t', ('major', 'minor', 'micro', 'patch', 'releaselevel', 'serial'),
)

SERIES = 'Cipater'
VERSION = version_info_t(3, 1, 16, 1, '', '')
__version__ = '{0.major}.{0.minor}.{0.micro}.{0.patch}{0.releaselevel}'.format(VERSION)
